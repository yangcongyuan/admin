...
<head>
    ...
    <!-- ================== BEGIN OTHER CSS STYLE ==================-->
    <link href="${pageContext.request.contextPath}/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/plugins/bootstrap-calendar/css/bootstrap_calendar.css" rel="stylesheet" />

    <link href="${pageContext.request.contextPath}/plugins/morris/morris.css" rel="stylesheet" />
                    ...
                    <div data-scrollbar="true" data-height="225px">
                        <ul class="chats">
                            <li class="left">
                                ...
                                <a href="javascript:;" class="image"><img alt="" src="${pageContext.request.contextPath}/images/user-12.jpg" /></a>
                                <div class="message">
                            ...
                            <li class="right">
                                ...
                                <a href="javascript:;" class="image"><img alt="" src="${pageContext.request.contextPath}/images/user-13.jpg" /></a>
                                <div class="message">
                            ...
                            <li class="left">
                                ...
                                <a href="javascript:;" class="image"><img alt="" src="${pageContext.request.contextPath}/images/user-10.jpg" /></a>
                                <div class="message">
                            ...
                            <li class="left">
                                ...
                                <a href="javascript:;" class="image"><img alt="" src="${pageContext.request.contextPath}/images/user-14.jpg" /></a>
                                <div class="message">
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-4">
                ...
                <ul class="registered-users-list clearfix">
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-5.jpg" alt="" /></a>
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-3.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Ancient Caviar
                            <small>Korean</small>
                        </h4>
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-1.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Marble Lungs
                            <small>Indian</small>
                        </h4>
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-8.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Blank Bloke
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-2.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Hip Sculling
                            <small>Cuban</small>
                        </h4>
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-6.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Flat Moon
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-4.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Packed Puffs
                    ...
                    <li>
                        <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/user-9.jpg" alt="" /></a>
                        <h4 class="username text-ellipsis">
                            Clay Hike
                            <small>Swedish</small>
                        </h4>
...
<script src="${pageContext.request.contextPath}/js/base/index.js"></script>
<script>
