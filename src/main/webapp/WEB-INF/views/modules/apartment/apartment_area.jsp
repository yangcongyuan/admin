  ...
  <head>
	...
	$(document).ready(function () {
		...
		dtable = $('#data_table').DataTable({
			ajax: {
		    	url: basePath + "/rest/apartment/queryApartmentArea",
            	type: "post",
		    ...
		    columns: [
		        ...
		        {title: '房屋面积', data: 'value', width: '20%', defaultContent: ''},
	...
	function addDataSubmit()
	{
		...
		$.ajax({
            url: basePath + "/rest/apartment/addApartmentArea",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	{
		$.ajax({
            url: basePath + "/rest/apartment/getApartmentArea",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	function updDataSubmit()
	{
		...
		$.ajax({
            url: basePath + "/rest/apartment/updApartmentArea",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	function delData(id)
	{
		...
		{
			$.ajax({
	            url: basePath + "/rest/apartment/delApartmentArea",
	            contentType: "application/json; charset=utf-8",
	            dataType: "json", 
	            type: "post", 
	            data: JSON.stringify({
  ...
  <body>
    ...
    <div class="panel panel-inverse">
   	<div class="panel-heading">
        ...
        <h4 class="panel-title">房屋面积管理</h4>
    </div>
    ...
    <div class="table-responsive">
		...
		<div class="form-group m-r-10">
			...
			<input type="text" class="form-control" id="value_q"/>
		</div>
