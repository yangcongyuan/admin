  ...
  <head>
	...
	$(document).ready(function () {
		...
		dtable = $('#data_table').DataTable({
			ajax: {
		    	url: basePath + "/rest/apartment/queryApartmentType",
            	type: "post",
		    ...
		    columns: [
		        ...
		        {title: '房屋类型', data: 'value', width: '20%', defaultContent: ''},
	...
	function addDataSubmit()
	{
		...
		$.ajax({
            url: basePath + "/rest/apartment/addApartmentType",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	{
		$.ajax({
            url: basePath + "/rest/apartment/getApartmentType",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	function updDataSubmit()
	{
		...
		$.ajax({
            url: basePath + "/rest/apartment/updApartmentType",
            contentType: "application/json; charset=utf-8",
            dataType: "json", 
            type: "post", 
            data: JSON.stringify({
	...
	function delData(id)
	{
		...
		{
			$.ajax({
	            url: basePath + "/rest/apartment/delApartmentType",
	            contentType: "application/json; charset=utf-8",
	            dataType: "json", 
	            type: "post", 
	            data: JSON.stringify({
  ...
  <body>
    ...
    <div class="panel panel-inverse">
   	<div class="panel-heading">
        ...
        <h4 class="panel-title">房屋类型管理</h4>
    </div>
