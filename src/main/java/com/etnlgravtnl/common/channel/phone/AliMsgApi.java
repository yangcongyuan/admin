package com.etnlgravtnl.common.channel.phone;
...
/**
 * Created by guozheng on 2016/5/11.
 */
public class AliMsgApi {
    ...
    private static final String appKey = "23358136"; // 可替换为您的沙箱环境应用的appKey
...
//        params.put("num_iid", "123456789");
        ...
        params.put("sms_free_sign_name","注册验证");
        params.put("sms_param","{\"code\":\""+securityCode+"\",\"product\":\"驷鹿电商\"}");
